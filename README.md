In this branch, We are going to explore minimalism 

Here is the rules

1. We start from nothing but vanilla neovim  

2. we add a configuration file each day , we seperate them by files due to the habit i have.

For example, you can add a keymaps.lua in one day, but this file can only be used to config keymaps related stuff.
In that case, I even have to using a day to just install lazy (or maybe i could just use vim.pack QAQ) 
